...
export const AdminDashboard = ({
  ...
  const advanceTeam = (
    teamName: string,
    round: "ottavi" | "quarterFinals" | "semiFinals" | "final",
    index: number,
  ) => {
            ...
            {viewMode === "tabellone" && (
              <>
                ...
                {tournamentState.is_drawn && (
                  ...
                  >
                    {" "}
                    <Trash2 size={16} /> Reset Tabellone{" "}
                  </button>
                )}
                <button
                  onClick={onDraw}
                    ...
                    {[0, 1, 2, 3].map((idx) => (
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (!newBracket.gironi[gName])
                            newBracket.gironi[gName] = ["", "", "", ""];
                        ...
                        <div key={j} className="flex gap-2 items-center">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              if (!newBracket.ottavi)
                                newBracket.ottavi = Array(16).fill("");
                        ...
                        <div key={j} className="flex gap-2">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              if (!newBracket.quarterFinals)
                                newBracket.quarterFinals = Array(8).fill("");
                              newBracket.quarterFinals[i * 2 + j] =
                                e.target.value;
                              setEditingBracket(newBracket);
                            }}
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              advanceTeam(team, "quarterFinals", i)
                            }
                            disabled={!team}
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              if (!newBracket.semiFinals)
                                newBracket.semiFinals = Array(4).fill("");
